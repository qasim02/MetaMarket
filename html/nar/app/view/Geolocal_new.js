...
Ext.define('NR.view.Geolocal', {
	...
	html : '<div id="mapDiv" width="100%" height="100%" style="width:100%; height:100%"> </div>',
	...
	/* L'oggetto google.maps.Map */
	gmap : null, // Da inizializzare!
	...
	icons : {
		...
		//"Misc":"app/resources/markers/information.png"
	...
	/* Metodo chiamato al momento dell'istanziazione */
	initMap : function() {
		/* Inizializzo la configurazione della mappa */
		var mapopts = {
			zoomLevel : 14,
			mapTypeId : google.maps.MapTypeId.ROADMAP,
			center : new google.maps.LatLng(44.49706, 11.356277)
		};
		...
		this.lat = lat;
		this.lng = lng;
		var coordObj = new google.maps.LatLng(lat, lng);
		/* Verifico se è disponibile la geolocalizzazione */
		...
		if (false && navigator.geolocation){
			...
			navigator.geolocation.getCurrentPosition(
				...
				function success(position){
					...
					var posObj = new google.maps.LatLng(mylat, mylong);
					mapopts.center = posObj;
				},
				
				function error(msg){
					/* Altrimenti vado sull'indirizzo di fallback */
					// POPUP?
					mapopts.center = coordObj;
				}
			);
		...
		/* Visualizzo la mappa */
		var mymap = new google.maps.Map(mapdiv, mapopts);
		this.gmap = mymap;
	},
